<template>
  <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3386.34 3010.5" shape-rendering="geometricPrecision"
    ...
    <path
      ...
      fill="#5f01d1" fill-rule="nonzero" /></svg>
</template>
