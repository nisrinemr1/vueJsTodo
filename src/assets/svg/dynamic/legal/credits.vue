<template>
  <svg width="100%" height="100%" x="0" y="0" viewBox="0 0 512.009 512.009">
    <g>
      <g xmlns="http://www.w3.org/2000/svg">
        <g>
          <circle cx="255.999" cy="64.005" r="64" :fill="color ? color : '#000000'" data-original="#000000"></circle>
        </g>
      </g>
      <g xmlns="http://www.w3.org/2000/svg">
        <g>
      ...
      <g xmlns="http://www.w3.org/2000/svg">
        <g>
          <circle cx="415.999" cy="64.005" r="64" :fill="color ? color : '#000000'" data-original="#000000"></circle>
        </g>
      </g>
      <g xmlns="http://www.w3.org/2000/svg">
        <g>
